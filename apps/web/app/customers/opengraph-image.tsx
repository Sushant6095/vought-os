...
export const alt = 'Vought Customers · Built for conversations that move revenue.';
        ...
        <div style={{ display: 'flex', alignItems: 'center' }}>
          <div
            style={{
              ...
              color: '#3358ff',
              fontWeight: 600,
              border: '1px solid rgba(51,88,255,0.4)',
              padding: '6px 16px',
              borderRadius: 100,
            }}
          >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
            <div style={{ display: 'flex', fontSize: 26, color: 'rgba(255,255,255,0.55)', fontWeight: 400, lineHeight: 1.5 }}>
              How revenue teams scale fastest on Vought.
            </div>
            <div style={{ display: 'flex', fontSize: 26, color: 'rgba(255,255,255,0.55)', fontWeight: 400, lineHeight: 1.5 }}>
              First ROI in twelve days. 73% suggestion acceptance.
            </div>
          </div>
        </div>
